package it.tsm.wiam.onepiece.util;

public class OnePieceCostants {
    ...
    public static class CodiciErrori{
        ...
        public static final String NOT_FOUND = "OP-404";
        public static final String BAD_REQUEST = "OP-400";
        public static final String CONFLICT = "OP-403";
    }
